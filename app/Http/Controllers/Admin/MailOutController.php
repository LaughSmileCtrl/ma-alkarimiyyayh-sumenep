...
class MailOutController extends Controller
{
    ...
    {
        $typeId = FileCategory::where('title', 'mail-out')->first()->id;
    ...
    public function update(UpdateFileRequest $request, $id)
    {
        ...
        if ($request->file) {
            ...
            Storage::delete('file/mail-out/'.$file->file);
