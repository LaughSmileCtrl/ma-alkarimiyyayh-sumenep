                ...
                <table class="table w-full">
                    ...
                    <tbody>
                        <tr v-for="i in 10" :key="i">
                            ...
                            <td>SMP Lorem Ipsum</td>
                            <td class="flex flex-row gap-2">
                                <div data-tip="lihat detail" class="tooltip tooltip-bottom">
                                    <Link :href="route('ppdb.show')" class="btn btn-accent btn-sm"><i class="fas fa-info"></i></Link>
                                </div>
                                <div data-tip="edit" class="tooltip tooltip-bottom">
                                    <Link :href="route('ppdb.edit')" class="btn btn-secondary btn-sm"><i class="fas fa-pen"></i></Link>
                                </div>
